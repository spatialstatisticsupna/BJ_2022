...
#### Check the results in terms of different model selection criterion
...
table=cbind(round(rbind(results1,results2,results3,results4,results5,results6,results7,
                      results8),3))

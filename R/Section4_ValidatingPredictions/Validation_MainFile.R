...
#### GENERATE DATA SETS FOR VALIDATION (Saved in DataforValidation folder)
...
#### FIT THE MODELS (Saved in Rdatas folder)
...
# Note that incidence data are available up to "2005_2006" (ag=8). Therefore we validate 4 period
...
#### SAVE THE RESULTS (Saved in ValidationResults folder)
#### We save in new .txt files the observed and predicted counts period by period
selmodels=1:8
...
# medidas[order(medidas$pred),]
# xtable(medidas[order(medidas$pred),])
